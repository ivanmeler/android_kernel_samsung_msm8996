...
#define FW_DEFAULT_SENSOR_VER		"B16AL"
...
#define STAT2_READREG_ADDR_LSB		0xE500	/* 73C2 Addr */

#define	API_SFLASH_CMD				0x0014
#define	API_SFLASH_SRAM_ADD			0x001C
#define	API_SFLASH_SIZE				0x0020
#define	API_SFLASH_CRC32			0x002C
#define	HOST_INTRP_FLASHCMD			0x6806
